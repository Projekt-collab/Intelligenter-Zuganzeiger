"""
Django settings for izz project.
...
SECRET_KEY = 'django-insecure-2*mfbiz0mlsud=c%7e291sng972861oarofq6=d$73-gc4@9d7'
...
WSGI_APPLICATION = 'izz.wsgi.application'

ASGI_APPLICATION = 'izz.asgi.application'
